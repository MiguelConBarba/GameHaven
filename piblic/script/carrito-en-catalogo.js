...
const showHTML = () => {
    ...
    // FUNCION si el carrito está vacío mostrar mensaje especial
    ...
    // rowProduct.innerHTML = '' Evita que se inserten mal los productos   
    ...
    allProducts.forEach(product => {        
        ...
        // FUNCION actualizar valor total y la cantidad de productos mostrada
